...
public class ExtensionApiControllerTest {
    ...
    void addCustomExtensionInvalidFormat() throws Exception {
        ...
        mockMvc.perform(post("/api/custom-extensions")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(request))
                .andExpect(status().is(INVALID_EXTENSION_FORMAT.getHttpStatus().value()))
    ...
    void addCustomExtensionDuplicate() throws Exception {
        ...
        mockMvc.perform(post("/api/custom-extensions")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(request))
                .andExpect(status().is(CUSTOM_EXTENSION_ALREADY.getHttpStatus().value()))
    ...
    void addCustomExtensionConflictWithFixed() throws Exception {
        ...
        mockMvc.perform(post("/api/custom-extensions")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(request))
                .andExpect(status().is(CUSTOM_EXTENSION_CONFLICT_WITH_FIXED.getHttpStatus().value()))
    ...
    void addCustomExtension_LimitExceeded() throws Exception {
        ...
        mockMvc.perform(post("/api/custom-extensions")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(request))
                .andExpect(status().is(CUSTOM_EXTENSION_LIMIT_EXCEED.getHttpStatus().value()))
    ...
    void addCustomExtensionLengthExceeded() throws Exception {
        ...
        mockMvc.perform(post("/api/custom-extensions")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(request))
                .andExpect(status().is(EXTENSION_LENGTH_EXCEED.getHttpStatus().value()))
